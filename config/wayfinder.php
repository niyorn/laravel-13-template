...
return [
    'generate' => [
        ...
        'inertia' => [
            // Disabled: the generated auth.user is typed from raw DB columns (leaks
            // hidden fields, lacks the `avatar` accessor, is nullable). The curated
            // sharedPageProps in resources/js/types/global.d.ts is more accurate.
